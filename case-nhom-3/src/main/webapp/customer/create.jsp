            ...
            <div class="card">
                <form method="post" class="form-card">
                    <div class="row justify-content-between text-left">
                        <div class="form-group col-sm-6 flex-column d-flex"><label class="form-control-label px-3">Mã Khách hàng<span
                                class="text-danger"> *</span></label>
                            <input type="text" id="code" name="code" placeholder="Mã khách hàng..." onblur="validate(1)">
                        </div>
                    ...
                    <div class="row justify-content-end">
                        ...
                        <div class="form-group col-sm-6">
                            <a style="text-decoration: none; margin: auto 0;line-height: 3;"
                               class="btn-block btn-primary" href="/CustomerServlet">QUAY LẠI</a>
                        </div>
                    </div>
                </form>
            </div>
