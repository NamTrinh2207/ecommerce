  ...
  <div class="table-responsive">
    <div class="table-wrapper">
      <div class="table-title">
        <div class="row">
          <div class="col-sm-8"><h2>CUSTOMER MONEY TOTAL LIST</h2></div>
        </div>
      </div>
      <table class="table table-striped table-hover table-bordered">
        ...
        <tr>
          ...
          <th>Customer Money Total</th>
        </tr>
        </thead>
        <tbody>
        <c:forEach items="${requestScope.customerOrders}" var="customerOrder">
          <tr>
...
<script type="text/javascript">
  ...
  function updateStatus(orderId, status)
  {
    if (confirm("Bạn có chắc chắn cập nhật hóa đơn có id là " + orderId + " không ? ")) {
      window.location = "/orders?action=statusUpdate&orderId=" + orderId+"&status="+status;
    }
  }
</script>
</body>
